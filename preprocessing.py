...
def create_dataset():
    ...
    df_filtered_columns = df_dataset[['patient_file_name', 'patient_name', 'tumor_stage', 'metastatic_status', 'anatomic_neoplasm_subdivision', 'metastasis_site', 'cg00820405', 'cg06282596', 'cg06721601', 'cg12245706', 'cg14196395', 'cg17291767', 'cg18766900', 'cg20253855', 'cg21113446', 'cg22300566']]
    df_filtered_columns.to_csv('/Users/thaarun/PythonProjects/AIResearch/output/results/MLDatasetFeaturesTop10.csv', index=False, sep=',')
